...
{acl}[ {ycl}4. {acl}] {gcl}RAFI_VAI (FB PAGE)
{acl}[ {ycl}5. {acl}] {gcl}TG ( TBB CYBER ZONE )
...
try:
  while True:
    ...
    if mao=="1":
      ...
      os.system('xdg-open https://www.facebook.com/rafi.sarker.9085/')
      break
    elif mao=="5":
      os.system('xdg-open https://t.me/khelaghor2')
      break
    elif mao=="0":
