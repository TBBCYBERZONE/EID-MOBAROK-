...
logo3=("""         
    ____  ____  ____        ____  ____  __  _______  __________ 
   / __ \/ __ \/ __ \      / __ )/ __ \/  |/  / __ )/ ____/ __ \
  / /_/ / /_/ / / / /_____/ __  / / / / /|_/ / __  / __/ / /_/ /
 / ____/ _, _/ /_/ /_____/ /_/ / /_/ / /  / / /_/ / /___/ _, _/ 
/_/   /_/ |_|\____/     /_____/\____/_/  /_/_____/_____/_/ |_|  
                                                                                                                                
\033[1;94m[+]===============================================================[+]
\033[1;94m[+]\033[1;32m               CREATED BY   :  TUSHAR                  \033[1;94m[+]
\033[1;94m[+]\033[1;32m               ON GITHUB    :  TBBCYBERZONE                        \033[1;94m[+]
...
\033[1;94m[+]\033[1;32m               TOOL'S NAME  :  Sms Bombers                  \033[1;94m[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46m🦋⃟TBB-CYBER✮⃝  𝐈𝐍𝄟⃝💥  SMS WAS SENT🐼")
  else:
    pass
